...
<template>
  <div class="w-[786px] h-[468px]">
    <div
      class="relative bg-[linear-gradient(to_top,oklch(0.2_0.05_250/0.9),oklch(0.2_0.05_250/0.4)_90%),url('@/assets/img/son.jpeg')] bg-cover bg-center w-full h-full rounded-[20px]"
    >
