...
<template>
  <div
    class="flex flex-col w-[358px] h-[243px] rounded-[16px] px-[24px] py-[24px] bg-white border-1 border-[#E3E3E3] dark:bg-[#262626] dark:border-[#343434]"
  >
    <div class="flex mb-[20px]">
      <div class="flex items-center gap-[10px]">
        <img src="@/assets/img/exImage/userImg.svg" alt="userImg" class="w-[40px] h-[40px]" />
        <p class="text-[16px]">혁신적인 돼지</p>
      </div>
      <p class="text-[#7537E3] dark:text-[#A878FD] text-[16px] ml-auto">#스포츠</p>
    </div>
    <div class="text-[16px] font-extralight max-w-[310px] max-h-[107] mb-[9px]">
      아니 나는 이강인이 결승전만큼은 뛰었으면 좋겠다고 생각했는데 진짜 너무아쉽다. 다음에는 꼭 더
      잘하면 좋겠다 진짜 내가 얼마나 응원하는데 진짜
    </div>
