<script setup></script>
<template>
  <div class="flex flex-col w-[830px] min-h-[846px] px-10 rounded-[16px] border border-gray-200">
    <!-- 작성자 -->
    <div class="flex w-full justify-between mt-8">
      <div class="flex gap-[10px] items-center">
        <img src="../../assets/img/communitywriterProfile.svg" class="w-12 h-12" />
        <p class="ml-[10px] text-lg text-[#191919]">부패한 황소</p>
      </div>
    ...
    <!-- 제목 -->
    <div class="mt-8 text-2xl">소고기가 최고지</div>
    <!-- 내용 -->
