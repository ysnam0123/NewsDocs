...
<template>
  <div class="flex items-center gap-[24px] w-[830px] h-[237px] group cursor-pointer">
    ...
    <img
      ...
      class="w-[232px] h-[171px] bg-gray-300 group-hover:opacity-80"
    />
      ...
      <div class="flex flex-col justify-center w-[574px] h-[172px]">
        ...
        <div class="w-full h-10 flex items-center justify-between">
          ...
          <div class="flex gap-[9.5px] items-center">
            ...
            <div class="text-[16px] font-semibold">userName</div>
          </div>
          <!-- 태그 -->
          <p class="flex items-center text-[16px] text-[#7537E3]">#스포츠</p>
        </div>
        <!-- 내용 -->
        <div class="mt-5">
          <div class="text-xl group-hover:text-[#515151] text-[#191919] font-semibold">
            제목입니당
          </div>
          <div class="mt-[6px] text-[14px] group-hover:text-[#515151] text-[#191919]">
