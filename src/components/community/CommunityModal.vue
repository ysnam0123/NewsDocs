  ...
  <div class="fixed inset-0 bg-[#000000]/30 flex justify-center items-center z-20">
    <div class="flex flex-col w-120 h-[679px] bg-[#ffffff] rounded-[16px] p-8">
      <div class="relative inline-block">
        <button
          @click="toggleModal"
          class="flex relative w-[132px] h-[46px] justify-between items-center rounded-[8px] border border-[#E0E0E0] cursor-pointer px-[10px] hover:border-[#BBBBBB] hover:shadow-[0_4px_4px_rgba(0,0,0,0.25)]"
        >
          <p
            class="flex items-center gap-2 text-[14px] leading-[40px]"
            :class="selectedCategory !== '카테고리 선택' ? 'text-[#191919]' : 'text-[#D7D7D7]'"
          >
            <img
        ...
        <div
          v-if="isSortOpen"
          class="absolute top-[100%] mt-[12px] w-[132px] bg-[#ffffff] border border-[#F6F6F6] rounded-[8px] shadow-[0_4px_10px_rgba(0,0,0,0.16)] z-40"
        >
          <ul>
            <li
              ...
              class="flex items-center gap-2 px-[12px] py-[14px] text-[14px] cursor-pointer hover:bg-[#F6F6F6]"
            >
      ...
      >
        <input
          class="min-w-[172px] h-[34px] mb-[15px] text-[24px] text-[#191919] placeholder-[#D7D7D7] group-hover:placeholder-[#BBBBBB] focus:outline-none"
      ...
      <!-- 이미지업로드 -->
      <div
        class="flex flex-col items-center justify-center w-[416px] min-h-[197px] mt-6 border border-[#EAEAEA] rounded-[12px] bg-[#F6F6F6] hover:bg-[#CACACA] cursor-pointer"
      >
        <img
      ...
      <div class="mt-4 w-104">
        <!-- 게시글 입력 -->
        <textarea
          class="w-full h-[197px] rounded-[12px] text-[14px] text-[#191919] placeholder-[#D7D7D7] border border-[#EAEAEA] p-4"
        ...
        <div class="flex justify-end mt-6 w-full h-11 gap-[10px]">
          <button
            @click="handleModal"
            class="flex items-center justify-center w-[110px] h-11 rounded-[8px] bg-[#F6F6F6] cursor-pointer text-[14px] text-[#191919]"
          >
            취소
          </button>
          <button
            @click="handleModal"
            class="flex items-center justify-center w-[110px] h-11 rounded-[8px] bg-[#7537E3] cursor-pointer text-[14px] text-[#FFFFFF]"
          >
            업로드
          </button>
        </div>
