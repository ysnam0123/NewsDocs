...
<template>
  ...
  >
    ...
    <img :src="news.image_url" class="mx-auto mb-20 w-full h-auto rounded-2xl px-20" />
  ...
  <section>
    <h2 class="text-2xl mb-6">관심 가질만한 다른 뉴스</h2>
    <NewsComponent9 class="border-1 border-gray-200 rounded-2xl" />
  </section>
  <section>
    <div>
      <h2>'스포츠'에 대한 다른 유저의 생각</h2>
      <button>더보기</button>
