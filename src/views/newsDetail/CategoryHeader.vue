...
<template>
  ...
  <section class="sm:flex hidden w-full mt-6">
    <div class="w-full">
      <ul class="flex items-center">
        <li
          class="text-black px-4 py-2 mr-3 rounded-lg whitespace-nowrap text-center cursor-pointer transition duration-300"
          :class="[
            allCategory
              ? 'bg-black text-white  dark:bg-[#7846D2] '
              : 'bg-[#F3F3F3]  dark:bg-[#363636] dark:text-white',
