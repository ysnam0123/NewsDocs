...
<template>
  <section class="mt-10 sticky top-[60px]">
    <div>
      ...
      <div class="w-[307px] flex cursor-pointer">
        <div class="block">
          <span class="text-[13px] text-[#7F7F7F] hover:text-[#8F8F8F]">#정치</span>
          <h3 class="hover:text-[#8F8F8F]">유강민 선수 최고기록 돌파...시속 620km로 압도적 우승</h3>
        </div>
